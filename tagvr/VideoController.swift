...
// VideoController
class VideoController: UIViewController, SCNSceneRendererDelegate, UIGestureRecognizerDelegate {
...
//MARK: View Did Load
    override func viewDidLoad() {
        ...
        recognizer                                  = UITapGestureRecognizer(target: self, action:#selector(VideoController.tapTheScreen))
        recognizer!.delegate                        = self
        view.addGestureRecognizer(recognizer!)
        
        panRecognizer                               = UIPanGestureRecognizer(target: self, action: #selector(VideoController.panGesture(_:)))
    ...
    func createSphereNode(material: AnyObject?) -> SCNNode {
        ...
        sphereNode.pivot                                                 = SCNMatrix4MakeRotation(Float(M_PI_2), 0.0, -1.0, 0.0)
...
//            
    ...
    @IBAction func playPausePlayer() {
        ...
        playButton.setImage(UIImage(named: (true == playingVideo) ? "pause@3x.png" : "play@3x.png"), for: .normal)
